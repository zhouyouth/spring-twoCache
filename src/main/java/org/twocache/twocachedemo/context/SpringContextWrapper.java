package org.twocache.twocachedemo.context;

import org.springframework.beans.BeansException;
import org.springframework.context.ApplicationContext;
import org.springframework.context.ApplicationContextAware;
import org.springframework.stereotype.Component;
import org.twocache.twocachedemo.utils.Hashing;
...
public class SpringContextWrapper  {
    ...
    public static <T> T getBean(String contextKey, Class<T> clazz) {
        checkApplicationContext();
        ApplicationContext context = instance.get(contextKey);
        if (context == null) {
            throw new IllegalStateException("ApplicationContext not found for key: " + contextKey);
        }
...
//        return String.valueOf(clazz.getName().hashCode());
