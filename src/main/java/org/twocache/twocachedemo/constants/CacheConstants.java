package org.twocache.twocachedemo.constants;
...
//    public static final String SUPER_FIELD_DYNAMIC = "dynamic";
    public static final String SUPER_FIELD_DYNAMIC = "allowRuntimeCacheCreation";
    ...
    public static final String SUPER_FIELD_USEPREFIX = "usePrefix";
    public static final String SUPER_FIELD_CACHEPREFIX = "keyPrefix";
    public static final String SUPER_FIELD_REDISOPERATIONS = "redisoperations" ;
}
