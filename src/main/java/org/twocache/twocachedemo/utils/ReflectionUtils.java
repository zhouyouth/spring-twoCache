...
public class ReflectionUtils {
    ...
    public static Field getDeclaredField3(Object object, String fieldName) {
        Field field = null;
    ...
    public static Object getFieldValue3(Object object, String fieldName) {

        //根据 对象和属性名通过反射 调用上面的方法获取 Field对象
        Field field = getDeclaredField3(object, fieldName);
