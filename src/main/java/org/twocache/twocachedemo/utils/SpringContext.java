...
public class SpringContext implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) {
        ...
        log.debug(SpringContext.class.getName() + " 类加载的路径：" + this.getClass().getResource("/").getPath() + ", hashcode:" + this.getClass().getResource("/").getPath().hashCode());
        log.debug(SpringContext.class.getName() + " applicationContext===>>>" + applicationContext);
        log.debug("contextKey===>>> " + SpringContextWrapper.getContextKey(this.getClass()));
        String contextKey = SpringContextWrapper.getContextKey(this.getClass());
        SpringContextWrapper.setApplicationContext(contextKey, applicationContext);
    }
